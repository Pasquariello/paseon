...
export default function Index() {
	...
	return (
		<Layout>
            ...
            recipient_email="<input style={{border:"none", backgroundColor: '#F1F1F1'}} type="text" placeholder="YOUR EMAIL"></input>"
